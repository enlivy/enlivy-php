...
class ProjectPermissionReportService extends AbstractService
{
    use HasIncludes;
    use HasFilters;
    ...
    public function list(string $projectId, array $params = [], ?RequestOptions $opts = null): Collection
    {
        ...
        return $this->requestCollection('GET', $this->orgPath($orgId, "projects/{$projectId}/permission-reports"), $params, $opts);
    }
    ...
    public function retrieve(string $projectId, string $permissionId, array $params = [], ?RequestOptions $opts = null): EnlivyObject
    {
        ...
        return $this->request('GET', $this->orgPath($orgId, "projects/{$projectId}/permission-reports/{$permissionId}"), $params, $opts);
    }
    ...
    public function update(string $projectId, string $permissionId, array $params, ?RequestOptions $opts = null): EnlivyObject
    {
        ...
        return $this->request('PUT', $this->orgPath($orgId, "projects/{$projectId}/permission-reports/{$permissionId}"), $params, $opts);
    }
    ...
    public function delete(string $projectId, string $permissionId, array $params = [], ?RequestOptions $opts = null): EnlivyObject
    {
        ...
        return $this->request('DELETE', $this->orgPath($orgId, "projects/{$projectId}/permission-reports/{$permissionId}"), $params, $opts);
    }
